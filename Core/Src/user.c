...
//            }
            ...
            if (gameFlags[0] == 29)//艾利刷卡
            {
                ...
                char *fileName1 = "/BGM/30.mp3";
                PlayMusicName(&MUSIC_1, fileName1, strlen(fileName1), 单曲循环);
                char *fileName3 = "/BGM/31.mp3";
                PlayMusicName(&MUSIC_2, fileName3, strlen(fileName3), 单曲停止);
                gameFlags[0]++;
            }
